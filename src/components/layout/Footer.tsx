      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div className="pt-4">
              <Link to="/contact#form" className="bg-gradient-primary hover:shadow-primary-lg text-white px-6 py-3 rounded-xl text-sm font-bold transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center group">
